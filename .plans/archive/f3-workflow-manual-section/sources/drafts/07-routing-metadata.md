...
```json
{
  ...
  "source_documents": {
    ...
    "dev_output": "../../features/active/f3-workflow-manual-section/03-dev-notes/dev-output-summary.md",
    "dev_verify_report": "../../features/active/f3-workflow-manual-section/03-dev-notes/dev-verify-report.md",
  ...
  "next": "plan-archive",
  "next_command": "/plan-archive f3-workflow-manual-section"
}
```
...
- Bridge context 생성 이후 Feature Package 생성, `/dev-run`, `/dev-verify`가 완료되어 다음 단계는 `/plan-archive`다.
