...
F1 자식 IDEA가 사용자 Go 승인을 받아 `20-approved` 상태가 되었고, Epic은 `planning` 상태로 전환되었다. F1은 구현과 `/dev-verify`를 통과했으며 archive 대기 상태다.

- [IDEA-20260428-001](../../../ideas/20-approved/IDEA-20260428-001.md) — F1 브랜드, 로고, CTA 최소 반영 (`verified`, [Draft](../../../drafts/f1-optic-brand-cta/01-draft.md), [Package](../../../features/active/f1-optic-brand-cta/02-package/00-overview.md), [Dev summary](../../../features/active/f1-optic-brand-cta/03-dev-notes/dev-output-summary.md), [Dev verify](../../../features/active/f1-optic-brand-cta/03-dev-notes/dev-verification-report.md))
- F2 — 카피와 제품 라인업 정리
- F3 — 업무 매뉴얼형 스크롤 섹션 MVP
- F4 — 업무 흐름 애니메이션과 상태 표현
- F5 — 브랜드 자산, 메타데이터, 검증 정리
