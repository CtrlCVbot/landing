...
- [IDEA-20260429-002](../../../ideas/20-approved/IDEA-20260429-002.md) — F3 업무 매뉴얼형 스크롤 섹션 MVP (`feature-package-ready`, Standard lane, [SCREENING-20260429-002](../../../ideas/20-approved/SCREENING-20260429-002.md), [Draft](../../../drafts/f3-workflow-manual-section/01-draft.md), [PRD](../../../prd/10-approved/f3-workflow-manual-section-prd.md), [Review](../../../drafts/f3-workflow-manual-section/03-prd-review.md), [Wireframe](../../../wireframes/f3-workflow-manual-section/screens.md), [Wireframe Review](../../../wireframes/f3-workflow-manual-section/04-wireframe-review.md), [Bridge](../../../features/active/f3-workflow-manual-section/00-context/00-index.md), [Feature Package](../../../features/active/f3-workflow-manual-section/02-package/00-overview.md), 다음 단계 `/dev-run`)
- F4 — 업무 흐름 애니메이션과 상태 표현
- F5 — 브랜드 자산, 메타데이터, 검증 정리
