...
- [IDEA-20260429-001](../../../ideas/10-screening/IDEA-20260429-001.md) — F2 카피와 제품 라인업 정리 (`screened`, Go 제안, Standard lane, [SCREENING-20260429-001](../../../ideas/10-screening/SCREENING-20260429-001.md))
- F3 — 업무 매뉴얼형 스크롤 섹션 MVP
- F4 — 업무 흐름 애니메이션과 상태 표현
- F5 — 브랜드 자산, 메타데이터, 검증 정리
