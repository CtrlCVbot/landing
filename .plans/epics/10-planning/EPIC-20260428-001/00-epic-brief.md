...
- [IDEA-20260429-001](../../../ideas/20-approved/IDEA-20260429-001.md) — F2 카피와 제품 라인업 정리 (`prd-draft`, Standard lane, [SCREENING-20260429-001](../../../ideas/20-approved/SCREENING-20260429-001.md), [Draft](../../../drafts/f2-optic-copy-product-lineup/01-draft.md), [PRD](../../../prd/00-draft/f2-optic-copy-product-lineup-prd.md), 다음 단계 `/plan-review`)
- F3 — 업무 매뉴얼형 스크롤 섹션 MVP
- F4 — 업무 흐름 애니메이션과 상태 표현
- F5 — 브랜드 자산, 메타데이터, 검증 정리
