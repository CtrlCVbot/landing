...
> 현재 상태는 `planning`이며, F1 Bridge context 생성을 완료했다.
...
|---|:---:|:---:|:---:|:---:|:---:|
| F1 | bridged | P7 완료 | 계획됨 | 낮음 | dev-feature 대기 |
| F2 | pending | — | — | — | — |
| F3 | pending | — | — | — | — |
| F4 | pending | — | — | — | — |
| F5 | pending | — | — | — | — |

상태 값: `pending` / `screening` / `approved` / `draft` / `scope-reviewed` / `bridged` / `active` / `archived`.
