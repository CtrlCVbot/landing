...
> 현재 상태는 `planning`이며, F1 Draft scope review를 완료했다.
...
|---|:---:|:---:|:---:|:---:|:---:|
| F1 | scope-reviewed | P3 review 완료 | 계획됨 | 낮음 | bridge 대기 |
| F2 | pending | — | — | — | — |
| F3 | pending | — | — | — | — |
| F4 | pending | — | — | — | — |
| F5 | pending | — | — | — | — |

상태 값: `pending` / `screening` / `approved` / `draft` / `scope-reviewed` / `active` / `archived`.
